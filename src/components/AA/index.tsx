...
const cardItems = [
  ...
  },
  {
    ...
    description:
      "This is single transaction to Generate API key",
      index: 5,
    icon: (
      <ControlPointIcon
        style={{
...
const AccountAbstraction: React.FC<Props> = ({ useCase, setUseCase, pageIndexChange }) => {
  ...
  return (
    <main className={classes.main}>
      <h3 className={classes.subTitle}>NAMESEEK API</h3>
      <p style={{ marginBottom: 25 }}>
        Here we have added some use cases from which users can test out the service.
      </p>
